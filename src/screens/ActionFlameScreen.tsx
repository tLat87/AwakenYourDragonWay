...
type RootStackParamList = {
    ActionFlameScreen: { category: string };
    FireExtinguisherGame: { category: string };
};

type Props = {
    navigation: StackNavigationProp<RootStackParamList, 'ActionFlameScreen'>;
route: RouteProp<RootStackParamList, 'ActionFlameScreen'>;
};

const ActionFlameScreen: React.FC<Props> = ({ navigation, route }) => {
